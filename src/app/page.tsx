...
export default function Home() {
  return (
    <main id="#main" className="mt-2 sm:mt-24">
      <section id="home" className="p-8">
        <div className="inline-block max-w-screen-xl m-auto max-sm leading-none md:flex flex-row justify-between">
      ...
      <section id="functions" className="mt-10 mb-32 p-8 sm:mb-40">
        <div className="m-auto font-sans font-bold text-3xl text-left ml-2 sm:text-5xl md:text-center">
          <AnimatedOnScroll
      ...
      <section className="h-3/5 pb-24 pt-24 min-h-fit border-t-[1px] p-8 border-y-zinc-800">
